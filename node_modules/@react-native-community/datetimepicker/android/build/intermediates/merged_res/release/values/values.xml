...
<resources xmlns:ns1="urn:oasis:names:tc:xliff:document:1.2" xmlns:ns2="http://schemas.android.com/tools">
    ...
    <style name="CalendarDatePickerDialog" parent="Theme.AppCompat.Light.Dialog" ns2:targetApi="lollipop">
        <item name="android:datePickerStyle">@style/CalendarDatePickerStyle</item>
    </style>
    <style name="CalendarDatePickerStyle" parent="android:Widget.Material.Light.DatePicker" ns2:targetApi="lollipop">
        <item name="android:datePickerMode">calendar</item>
    </style>
    <style name="ClockTimePickerDialog" parent="Theme.AppCompat.Light.Dialog" ns2:targetApi="lollipop">
        <item name="android:timePickerStyle">@style/ClockTimePickerStyle</item>
    </style>
    <style name="ClockTimePickerStyle" parent="android:Widget.Material.Light.TimePicker" ns2:targetApi="lollipop">
    ...
    <style name="SpinnerDatePickerDialog" parent="Theme.AppCompat.Light.Dialog" ns2:targetApi="lollipop">
        <item name="android:datePickerStyle">@style/SpinnerDatePickerStyle</item>
    </style>
    <style name="SpinnerDatePickerStyle" parent="android:Widget.Material.Light.DatePicker" ns2:targetApi="lollipop">
        <item name="android:datePickerMode">spinner</item>
    </style>
    <style name="SpinnerTimePickerDialog" parent="Theme.AppCompat.Light.Dialog" ns2:targetApi="lollipop">
        <item name="android:timePickerStyle">@style/SpinnerTimePickerStyle</item>
    </style>
    <style name="SpinnerTimePickerStyle" parent="android:Widget.Material.Light.TimePicker" ns2:targetApi="lollipop">
